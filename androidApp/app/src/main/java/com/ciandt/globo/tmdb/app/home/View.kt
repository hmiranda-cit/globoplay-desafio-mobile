...
import com.ciandt.globo.tmdb.app.R
...
@Composable
private fun TopBarLogo(modifier: Modifier = Modifier) {
    Box(
        contentAlignment = Alignment.Center,
        modifier = Modifier
            .then(modifier)
...
@Composable
private fun ContentList(sectionsRenderingData: List<SectionRenderingData>, modifier: Modifier = Modifier) {
...
@Composable
private fun ContentListSpacer(modifier: Modifier = Modifier) {
    Spacer(
        Modifier
            .requiredHeight(48.dp)
            .then(modifier)
...
@Composable
private fun Section(header: String, contents: List<SectionContent>, modifier: Modifier = Modifier) {
    Column(
